...
sed -i 's:$(ROMFSINST) $(SRC_NAME)/build/https_dns_proxy /usr/sbin/doh_proxy2:ln -s /usr/sbin/doh_proxy $(INSTALLDIR)/usr/sbin/doh_proxy2:' padavan-ng/trunk/user/doh_proxy/Makefile
