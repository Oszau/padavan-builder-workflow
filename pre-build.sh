...
#kernel
sed -i '636a\\tCONFIG_NET_SCH_TBF=m -p +x padavan-ng/trunk/configs/boards/$CONFIG_VENDOR/$CONFIG_FIRMWARE_PRODUCT_ID/kernel-3.4.x.config
sed -i '1334a\\tCONFIG_FSCACHE=m -p +x padavan-ng/trunk/configs/boards/$CONFIG_VENDOR/$CONFIG_FIRMWARE_PRODUCT_ID/kernel-3.4.x.config
sed -i '1335a\\tCONFIG_FSCACHE_STATS=y -p +x padavan-ng/trunk/configs/boards/$CONFIG_VENDOR/$CONFIG_FIRMWARE_PRODUCT_ID/kernel-3.4.x.config
