...
sed -i '184a:$(ROMFSINST) -p +x /etc_ro/ASUSddns.sh:' padavan-ng/trunk/user/Makefile
sed -i '185a:$(ROMFSINST) -s /etc_ro/ASUSddns.sh /etc/storage/ASUSddns.sh:' padavan-ng/trunk/user/Makefile
